...
export class UsersController {
   ...
   importSongs(
      ...
      return this.userService.updateUserSongs(list, user.id).then(() => new BaseResponse());
   }
   ...
   importArtists(
      ...
      return this.userService.updateUserArtists(list, user.id).then(() => new BaseResponse());
   }
